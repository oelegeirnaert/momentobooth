              ...
              return Column(
                children: [
                  SettingsNumberEditTile(
                    ...
                    onFinishedEditing: (v) =>
                        controller.onExternalSystemCheckIntervalChanged(v),
                  ),
                  for (final (index, status)
                      in getIt<ExternalSystemStatusManager>().systems.indexed)
                    ...
                    onPressed: () {
                      ...
                      showDialog(
                        ...
                        builder: (context) => ExternalSystemCheckEditDialog(
                          onSave: (newCheck) {
                            final checks = [
                              ...viewModel.externalSystemChecks,
                              newCheck,
                            ];
                            controller.onExternalSystemChecksChanged(checks);
...
class _BrowserSettingsSection extends StatelessWidget {
  @override
        ...
        FutureBuilder<List<String>>(
          ...
          builder: (context, snapshot) {
            ...
            return Column(
              ...
              children: [
                const Text('Configure from browser'),
